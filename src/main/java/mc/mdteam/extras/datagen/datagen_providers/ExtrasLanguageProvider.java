...
public class ExtrasLanguageProvider extends FabricLanguageProvider {
    ...
    public ExtrasLanguageProvider(FabricDataOutput dataOutput, LanguageType languageType) {
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        dataGenerator.getModContainer().findPath("assets/ait-extras/lang/en_us.existing.json").ifPresent(existingFilePath -> {
            try {
